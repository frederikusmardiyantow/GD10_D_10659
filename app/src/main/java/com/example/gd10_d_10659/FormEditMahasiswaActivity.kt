package com.example.gd10_d_10659
...
import com.example.gd10_d_10659.databinding.ActivityFormEditMahasiswaBinding
...
class FormEditMahasiswaActivity : AppCompatActivity() {
    ...
    fun getDetailData(nim:String) { RClient.instances.getData(nim).enqueue(object :
